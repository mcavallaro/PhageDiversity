...
fulltable2025<-read.csv("data/3May2025_data.tsv",
                        check.names = F,
						sep = '\t')
...
# Difference between DB24 and DB25
Summary<-merge(Summary_Sept2024, Summary_Sept2025,
			   by = 'host',
			   suffixes = c(".2024", ".2025"))
...
addNewDataPoints<-function(Host,
				           summary.df = Summary,
				           col = 'black'){
